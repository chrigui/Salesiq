...
const DEFAULTS: FeatureFlag[] = [
  ...
  },
  {
    ...
    description: "Real-time event feed for new leads, deals won, and system events like failed webhook deliveries.",
    beta: false,
    enabled: true,
  },
  {
    ...
    description: "Outbound webhook delivery when a lead is saved, configurable per tenant.",
    beta: true,
    enabled: true,
  },
  {
    id: "mqtt-sync",
    label: "MQTT Live Sync",
    description: "Cross-device companion/display pairing and live state sync.",
    beta: false,
    enabled: true,
  },
];
