...
export const realEstatePack: IndustryPack = {
  ...
  questions: [
    ...
    },
    {
      id: "homeFeatures",
      label: "Home features",
      prompt: "What would make the home feel right?",
      type: "multi",
      section: "home",
      options: [
        ...
        { id: "cityView", label: "City view", icon: "Building2" },
        { id: "parking", label: "Parking", icon: "Car" },
        { id: "maidsRoom", label: "Maid's room", icon: "BedDouble" },
        { id: "office", label: "Office", icon: "Briefcase" },
        { id: "storage", label: "Storage", icon: "Package" },
        { id: "privateEntrance", label: "Private entrance", icon: "DoorClosed" },
