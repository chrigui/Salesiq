 ...
 * Start -> Meet -> Discover -> Confirm -> Explore -> Decide journey runs
 * before the existing, untouched full Companion app, reachable as an
 * explicit escape hatch from the Explorer.
 */
